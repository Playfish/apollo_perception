...
#include "modules_perception_msgs/Point.h"
#include "modules_perception_msgs/PerceptionObstacle.h"
#include "modules_perception_msgs/PerceptionObstacles.h"
...
struct alignas(16) Object {
  ...
  bool Serialize(modules_perception_msgs::PerceptionObstacle* pb_obj) const;
  bool Deserialize(const modules_perception_msgs::PerceptionObstacle& pb_obs);
