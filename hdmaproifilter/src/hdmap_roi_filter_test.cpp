...
#include "perception/obstacle/lidar/roi_filter/hdmap_roi_filter/hdmap_roi_filter.h"
...
const char polygon_file_name[] =
    "/apollo/perception/data/hdmap_roi_filter_test/poly_mask_ut.poly";
const char pcd_file_name[] =
    "/apollo/perception/data/hdmap_roi_filter_test/poly_mask_ut.pcd";
...
void HdmapROIFilterTest::init() {
  FLAGS_work_root = "/apollo/perception/data";
