...
#include "perception/obstacle/common/geometry_util.h"
#include "perception/obstacle/lidar/tracker/hm_tracker/feature_descriptor.h"
#include "perception/obstacle/lidar/tracker/hm_tracker/hm_tracker.h"
#include "perception/obstacle/lidar/tracker/hm_tracker/hungarian_matcher.h"
#include "perception/obstacle/lidar/tracker/hm_tracker/kalman_filter.h"
#include "perception/obstacle/lidar/tracker/hm_tracker/track_object_distance.h"

namespace apollo {
namespace perception {
HmObjectTracker::HmObjectTracker(ros::NodeHandle& nh):
nh_(nh),
matcher_method_name("hungarian_matcher"), filter_method_name("kalman_filter"),
track_cached_history_size_maximum(5), track_consecutive_invisible_maximum(1),
track_visible_ratio_minimum(0.6), collect_age_minimum(0),
collect_consecutive_invisible_maximum(0), acceleration_noise_maximum(5),
speed_noise_maximum(0.4), match_distance_maximum(4.0),
location_distance_weight(0.6), direction_distance_weight(0.2),
bbox_size_distance_weight(0.1), point_num_distance_weight(0.1),
histogram_distance_weight(0.5), histogram_bin_size(10),
use_adaptive(true), measurement_noise(0.4),
initial_velocity_noise(5), xy_propagation_noise(10),
z_propagation_noise(10), breakdown_threshold_maximum(10.0),matcher_method_(HUNGARIAN_MATCHER),
