...
#include "perception/common/perception_gflags.h"
#include "perception/lib/config_manager/config_manager.h"
#include "perception/lib/pcl_util/pcl_types.h"
#include "perception/obstacle/common/file_system_util.h"
#include "perception/obstacle/common/pose_util.h"
#include "perception/obstacle/lidar/object_builder/min_box/min_box.h"
...
TEST_F(HmObjectTrackerTest, Track) {
  ...
  std::string data_path = "perception/data/hm_tracker_test/";
